...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   It is used to grab the url from other files

1. How would you explain form validation to someone who has never programmed before?

You know when you type in a username that is already taken or a password that is not secure enough and the form gives you an error like "username is already taken" or "password needs a simbol" that is what form validation is.

1. In 1-2 sentences, define end to end testing.

It is used to test every thing a bout a website before it launches, so that the site can as bugg free as possible.
